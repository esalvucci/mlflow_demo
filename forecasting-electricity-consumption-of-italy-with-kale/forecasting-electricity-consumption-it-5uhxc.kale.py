...
def load_data(rok_workspace_example_utf7s6i2o_url: str):
    ...
    pod_utils.snapshot_pipeline_step("forecasting-electricity-consumption-it-5uhxc",
                                     "load_data",
...
@dsl.pipeline(
    name='forecasting-electricity-consumption-it-5uhxc',
    description='Forecasting hourly electricity consumption in Italy'
)
def auto_generated_pipeline(rok_workspace_example_utf7s6i2o_url='http://rok.rok.svc.cluster.local/swift/v1/d88db09f-bf61-41d1-b3d6-515c2bd2f681/notebooks/example-0_workspace-example-utf7s6i2o?version=2e709d39-dc4b-482e-b323-38d4f89df17c'):
    pvolumes_dict = OrderedDict()

    annotations = {'rok/origin': 'http://rok.rok.svc.cluster.local/swift/v1/d88db09f-bf61-41d1-b3d6-515c2bd2f681/notebooks/example-0_workspace-example-utf7s6i2o?version=2e709d39-dc4b-482e-b323-38d4f89df17c'}
...
if __name__ == "__main__":
    ...
    run_name = 'forecasting-electricity-consumption-it-5uhxc_run'
