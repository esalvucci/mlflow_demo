...
def load_data(rok_workspace_example_utf7s6i2o_url: str):
    ...
    pod_utils.snapshot_pipeline_step("forecasting-electricity-consumption-it-prilv",
                                     "load_data",
    ...
    dataset_url = "https://raw.githubusercontent.com/esalvucci/mlflow_demo/main/forecasting-electricity-consumption-of-italy-on-gcp/datasets/it.csv"
...
@dsl.pipeline(
    name='forecasting-electricity-consumption-it-prilv',
    description='Forecasting hourly electricity consumption in Italy'
)
def auto_generated_pipeline(rok_workspace_example_utf7s6i2o_url='http://rok.rok.svc.cluster.local/swift/v1/d88db09f-bf61-41d1-b3d6-515c2bd2f681/notebooks/example-0_workspace-example-utf7s6i2o?version=3294703b-33f9-4c88-a76e-b543e82095b1'):
    pvolumes_dict = OrderedDict()

    annotations = {'rok/origin': 'http://rok.rok.svc.cluster.local/swift/v1/d88db09f-bf61-41d1-b3d6-515c2bd2f681/notebooks/example-0_workspace-example-utf7s6i2o?version=3294703b-33f9-4c88-a76e-b543e82095b1'}
...
if __name__ == "__main__":
    ...
    run_name = 'forecasting-electricity-consumption-it-prilv_run'
